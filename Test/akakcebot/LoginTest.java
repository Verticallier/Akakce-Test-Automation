...
class LoginTest {
    private static final String TEST_MAIL = "";     // TODO USER MUST FİLL THİS AREA
    private static final String TEST_PASSWORD = ""; // TODO  USER MUST FİLL THİS AREA ;
    ...
    void testLoginWithValidCredentials() throws InterruptedException {
        ...
        boolean result = bot.login(TEST_MAIL, TEST_PASSWORD);
        assertTrue(result);
    }
    ...
    void testRememberMeOption() throws InterruptedException {
        ...
        bot.login(TEST_MAIL, TEST_PASSWORD);
        bot.setCookies();
    ...
    void testRateLimiting() throws InterruptedException {
        ...
        int count = 0;
        while (true) {
            bot.login(TEST_MAIL, "wrong_password");
